    ...
    <div className="h-screen flex flex-col bg-[#000]">
      <div className="h-[60%] flex flex-col justify-between">
        <div className="h-[15%] w-[20%] flex items-center justify-center">
          <h1
            className="text-4xl text-[#e50914] font-bold cursor-pointer"
            onClick={() => navigate("/")}
          >
            BANJOFLIX
          </h1>
        ...
        <div className="h-[60%] flex flex-col justify-between">
          ...
          <div className="h-[70%] flex items-start justify-center">
            <div
              className="h-[67%] w-[6.5%] flex flex-col justify-between rounded-[3px] cursor-pointer who-img-holder"
              onClick={() => navigate("/browse")}
            >
              <img
                src={Account}
                alt=""
                className="h-full w-full object-cover rounded-[3px] cursor-pointer"
              />
